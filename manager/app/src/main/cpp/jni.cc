...
Java_me_weigui_kernelsu_Natives_becomeManager(JNIEnv *env, jobject, jstring pkg) {
...
Java_me_weigui_kernelsu_Natives_getVersion(JNIEnv *env, jobject) {
    return get_version();
}

extern "C"
JNIEXPORT jintArray JNICALL
Java_me_weigui_kernelsu_Natives_getAllowList(JNIEnv *env, jobject) {
    int uids[1024];
    int size = 0;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_weigui_kernelsu_Natives_isSafeMode(JNIEnv *env, jclass clazz) {
    return is_safe_mode();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_me_weigui_kernelsu_Natives_isLkmMode(JNIEnv *env, jclass clazz) {
    return is_lkm_mode();
}
...
Java_me_weigui_kernelsu_Natives_getAppProfile(JNIEnv *env, jobject, jstring pkg, jint uid) {
    ...
    auto cls = env->FindClass("me/weigui/kernelsu/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_weigui_kernelsu_Natives_setAppProfile(JNIEnv *env, jobject clazz, jobject profile) {
    auto cls = env->FindClass("me/weigui/kernelsu/Natives$Profile");
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_weigui_kernelsu_Natives_uidShouldUmount(JNIEnv *env, jobject thiz, jint uid) {
    return uid_should_umount(uid);
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_weigui_kernelsu_Natives_isSuEnabled(JNIEnv *env, jobject thiz) {
    return is_su_enabled();
}
extern "C"
JNIEXPORT jboolean JNICALL
Java_me_weigui_kernelsu_Natives_setSuEnabled(JNIEnv *env, jobject thiz, jboolean enabled) {
